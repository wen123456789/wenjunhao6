...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class GroupMessageApi
    {
        ...
        /// <returns></returns>
        public static SendResult SendGroupMessageByGroupId(string accessToken, string groupId, string value, GroupMessageType type, bool isToAll = false)
        {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static SendResult SendGroupMessageByOpenId(string accessToken, GroupMessageType type, string value,  params string[] openIds)
        {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult DeleteSendMessage(string accessToken, string msgId)
        {
                ...
                return ApiHelper.Post<SendResult>(accessToken, urlFormat, data);            
        }
        ...
        public static SendResult WxCardGroupMessagePreview(string accessToken, string cardId, string code,
            string openId, string wxName, string timestamp, string signature)
        {
            const string urlFormat = "https://api.weixin.qq.com/cgi-bin/message/mass/preview?access_token={0}";
        ...
        public static GetSendResult GetGroupMessageResult(string accessToken, string msgId)
        {
                ...
                return ApiHelper.Post<GetSendResult>(accessToken, urlFormat, data);            
